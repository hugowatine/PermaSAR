...
"""\
flatism_compute_stack.py
-------------
Compute a stack from a list of interferograms without a radar_file

Usage: compute_stack.py --homedir=<path> --int_path=<path> --int_list=<file> --nl_nc=<value>,<value>[--suffix=<value>] [--prefix=<value>] [--output=<file>] [--rlook=<value>] [--ref=<jstart,jend,istart,iend>] [--ramp=<yes/no>]
...
--nl_nc<nlines,ncols> number of lines and columns of the interferograms
--output
"""
...
nlines, ncols = map(int, arguments["--nl_nc"].split(','))
