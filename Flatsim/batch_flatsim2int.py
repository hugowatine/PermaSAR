...
Usage:
    batch_flatsim2int.py --path=<path> [--nproc=<n>] [--list_int=<file>]
...
def process_subdir(flatsim_script, base_dir, subdir):
    ...
    for f in os.listdir(full_path):
        if f.startswith("CNES_InW_geo") and f.endswith("mask_8rlks.tiff"):
...
def main():
    ...
    flatsim_script = os.path.expanduser("~/PermaSAR/Tools/flatsim2int.py")
